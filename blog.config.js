...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '星辰解説', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '星辰博客', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'xingchenblog.com', // 网站地址
